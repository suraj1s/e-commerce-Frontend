...
// import { checkUserAsync, selectIsLoading, selectLoggedInUser, selecterror } from "../authSlice";
...
//     const handelDemoLogin = ({email , password , role}) => {
...
//             <button onClick={()=>handelDemoLogin({email:'user@gmail.com' , password : 'User1234' , role: "user"})} className="flex w-fit justify-center rounded-md bg-green-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">User
//             {
...
//             </button>
//             <button onClick={()=>handelDemoLogin({email:'admin@gmail.com' , password : 'Admin1234', role: "admin"})} className="flex w-fit justify-center rounded-md bg-blue-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">Admin
//             {
